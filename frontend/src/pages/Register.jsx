...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      setError(err.response?.data || 'Failed to register account. Email might already be in use.');
    } finally {
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-gray-500">
          Start building your visual library of quotes today
        </p>
      </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <a
                ...
                className="w-full flex justify-center py-2.5 px-4 border border-gray-300 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none transition-all cursor-pointer items-center"
              >
