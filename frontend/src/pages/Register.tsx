    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="flex-1 lg:w-[40%] flex items-center justify-center bg-[#f9f8f6] px-8 py-14">
        <div className="w-full max-w-[360px]">
          <div className="mb-8">
            <h1 className="text-2xl font-bold font-serif text-slate-900 tracking-tight">Create an account</h1>
            <p className="text-sm text-slate-400 mt-1.5">Start building your library today.</p>
          </div>
